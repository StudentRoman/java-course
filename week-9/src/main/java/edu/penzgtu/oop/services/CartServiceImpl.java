...
/**
 * Класс CartServiceImpl является реализацией CartService
 * Класс CartServiceImpl представляет собой сервис для работы с корзиной пользователя.
 * Он обеспечивает методы для добавления книг в корзину, удаления книг из корзины и поиска корзин пользователей.
 */
