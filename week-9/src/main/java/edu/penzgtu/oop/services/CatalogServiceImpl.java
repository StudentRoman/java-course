...
/**
 * Класс CatalogServiceImpl является реализацией CatalogService
 * Класс CatalogServiceImpl представляет сервис каталога книг.
 * Он обеспечивает методы для получения списка и поиска книг.
 */
