...
/**
 * Класс CartRepository представляет репозиторий корзины книг. Данный класс наследуется от {@link Cart}.
 * Он обеспечивает методы для сохранения, обновления и удаления информации о книгах в корзине и поиска книг в базе данных.
 */
